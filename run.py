...
print(f"Pure FeCl3 dose is kg/d")
print(f'10% FeCl3 dose is {b} kg/d')
print(f'10% Pure FeCl3 dose is {c} m3/d')
print(f'40% FeCl3 dose is {d}kg/d')
print(f'40% Pure FeCl3 dose is {e}m3/d')
